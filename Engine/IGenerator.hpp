...
public:
	...
	/// <summary>
	/// Check if the generator should generate empty files
	/// that have only a StaticClass() method.
	/// </summary>
	/// <returns>true if empty files with StaticClass() should get generated.</returns>
	virtual bool ShouldGenerateEmptyFilesWithStaticClass() const
	{
		return true;
	}
	...
	/// <summary>
	/// Decides if a MessageBox can be used. (default: true)
	/// For example: UWP Applications will not show a MessageBox, it will just block the process.
	/// </summary>
	/// <returns>True if MessageBoxA should be used.</returns>
	virtual bool ShouldShowMessageBox() const
	{
		return true;
	}

	/// <summary>
	/// Allows to register a VectoredExceptionHandler (default: true)
	/// </summary>
	/// <returns>True if a VectoredExceptionHandler should be registered.</returns>
